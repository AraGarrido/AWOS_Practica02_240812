...
console.log(`Datos de la propiedad en RENTA:
    ...
    user1 =
    {
        userID: 32412,
        name: "Aranza Garrido",
        email: "agg@gamail.com",
        createdAt: new Date("2022/10/24 20:55:56"),
        lastLogin: new Date("2026/01/20 08:48:45"),
        userRole: ("Vandedor"),
        totalProperties: 12,
        rating: 9.4,
    }
    ...
    {
        userID: 85211,
        name: "Jacqueline Garrido",
        email: "jacque@gamail.com",
        createdAt: new Date("2023/04/21 10:25:38"),
        lastLogin: new Date("2026/02/14 22:18:55"),
        userRole: ("Comprador"),
        rating: 8.5,
    ...
    user3 =
    {
        userID: 4947,
        name: "Ricardo Lira",
        email: "richi@gamail.com",
        createdAt: new Date("2025/09/21 20:40:10"),
        lastLogin: new Date("2026/02/18 10:51:30"),
        userRole: ("Comprador"),
        rating: 8.5,
        lastOperation: "Buscando Departamento para renta"
    }
    ...
    {
        userID: 4846,
        name: "Nazly Gutiérrez",
        email: "naz@gamail.com",
        createdAt: new Date("2022/10/20 17:50:15"),
        lastLogin: new Date("2026/01/15 15:00:00"),
        userRole: ("Comprador"),
        rating: 8.5,
        lastOperation: "Buscando Departamento para renta"
    }
